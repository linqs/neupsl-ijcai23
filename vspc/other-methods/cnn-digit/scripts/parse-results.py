...
class CNNDigitResultsParser(results_parser.AbstractResultsParser):
...
def main():
    cnn_digit_results_parser = CNNDigitResultsParser(results_dir=RESULTS_DIR, log_filename=LOG_FILENAME, additional_headers=ADDITIONAL_HEADERS)
    results = cnn_digit_results_parser.parse_results()
    cnn_digit_results_parser.print_results(results)
