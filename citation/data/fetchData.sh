...
readonly DATA_URL=("https://linqs-data.soe.ucsc.edu/public/pryor-ijcai23/experiment::citeseer.zip" "https://linqs-data.soe.ucsc.edu/public/pryor-ijcai23/experiment::cora.zip")
readonly DATA_FILE=("experiment::citeseer.zip" "experiment::cora.zip")
readonly DATA_DIR=("experiment::citeseer" "experiment::cora")
